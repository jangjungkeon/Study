...
if __name__ == '__main__':
    ...
    # 학습 진행
    # model = RandomForestClassifier(n_estimators=100)  # RandomForestClassifier Bagging 방법, 병렬처리, 과적합, 오버피팅이 걱정되면 이거
    model = xgb.XGBClassifier(booster='gbtree', max_depth=4, n_estimators=100)     # XGBClassifier, boosting 방법, 직렬처리, 고성능
